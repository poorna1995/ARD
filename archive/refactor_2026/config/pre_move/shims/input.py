...
CONFIG_DATASETS = REPO_ROOT / "config/local/datasets.yaml"
# Legacy path (same file via symlink).
CONFIG_DATASETS_LEGACY = REPO_ROOT / "configs/datasets.yaml"
