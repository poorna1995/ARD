...
_JSON_EXAMPLES: dict[str, str] = {
    ...
    "mmlu_pro": '{"answer":"C","confidence":0.8,"complexity":0.3}',
...
ANSWER_FORMAT: dict[str, str] = {
    ...
    "mmlu_pro": "single option letter A-J",
...
REACT_BAD_FINAL_ANSWERS: frozenset[str] = frozenset({
    "",
    "<value>",
    "<short value>",
    "<answer>",
