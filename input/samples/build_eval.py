...
from input.loaders.gaia_loader import append_attachment_to_query
from config.local.constants.datasets import disk_dir_name
from input.loaders.mmlu_pro_loader import append_options_to_query
from config.global_config.paths import eval_samples_dir, processed_dir
...
def main() -> None:
    ...
    mmlu_df = pd.read_parquet(PROC / disk_dir_name("mmlu") / "test" / "data.parquet")
